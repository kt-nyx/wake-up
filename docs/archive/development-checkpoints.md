...
Processed-PNG caching remains retained from the preceding [PNG investigation](investigation-results.md#2026-09-07-png-processing-implementations). Its repeatable benefit applies to explicitly selected PNG-source workloads; first cache construction is slower and normal DDS selection provided no eligible PNG work here.
