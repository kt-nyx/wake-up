...
[0.2.0 release notes](https://github.com/kt-nyx/wake-up/blob/b2d83c324a1fdf6095d927d6ed12c695f4a49d5f/release/notes-0.2.0.md). The owner authorized a regular
...
[release notes](https://github.com/kt-nyx/wake-up/blob/b2d83c324a1fdf6095d927d6ed12c695f4a49d5f/release/notes-0.2.0-preview.1.md) distinguish implemented
...
Read the [user guide and supported-build policy](../user-guide.md) before normal installation. This remains a development build with exact Windows GOG, Windows Steam rev590 and Linux rev600 contracts; source admission and Workshop uploads do not establish universal 1.6 support or live qualification. Earlier identities and measurements are in [development checkpoints](development-checkpoints.md).
