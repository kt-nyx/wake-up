...
The owner reported a Workshop upload on 2026-09-08. Uploading does not establish
Steam compatibility or performance qualification, which remain pending.
The [Workshop description draft](../../release/steam-description.bbcode) is ready
to review and paste into Steam's description editor; it has not been posted by
the documentation task. Final README copy and preview-art review remain pending.
...
4. For the next update, package that revision, publish a matching source tag, and
   manually upload the inspected mod folder with the bundled source and notices.
...
is in [archived checkpoints](development-checkpoints.md#final-pre-rename-cleanup-bundle).
